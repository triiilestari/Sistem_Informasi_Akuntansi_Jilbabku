...
@section('container')
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
                <br />
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="/Pemasukkan.index">
                @csrf
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                      <a href="/Pemasukkan/index" class="btn btn-primary">Cancel</a>
